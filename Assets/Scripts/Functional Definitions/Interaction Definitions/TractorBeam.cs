...
public class TractorBeam : MonoBehaviour
{
    ...
    public static bool InvertTractorCheck(Entity owner, Draggable newTarget)
    {
        ...
        if (owner.tractorSwitched || !requestedTarget || ((requestedTarget.faction == owner.faction) && (requestedTarget is Drone || requestedTarget is Tank || requestedTarget is Tower || requestedTarget is Turret)))
        {
            return true;
        }
